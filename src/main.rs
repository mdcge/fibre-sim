...
impl Simulation {
    fn new(node_list: Vec<Node>, spring_constant: f32, rest_length: f32, grav: f32, node_diameter: f32, spring_thickness: f32) -> Simulation {
        let s = node_list.len() - 1;
        Simulation { nodes: node_list, k: spring_constant, x0: rest_length, g: grav, subdiv: s, dn: node_diameter, ds: spring_thickness }
    }

    fn new_straight(x_endpoints: Vec<f32>, spring_constant: f32, rest_length: f32, grav: f32, node_diameter: f32, spring_thickness: f32, mass: f32, subd: usize) -> Simulation {
        ...
        Simulation { nodes: node_list, k: spring_constant, x0: rest_length, g: grav, subdiv: subd, dn: node_diameter, ds: spring_thickness }
    }
}
...
fn model(_app: &App) -> Simulation {
    ...
    Simulation::new_straight(vec![-2.0, 2.0], 1.0, 0.0, 9.81, 10.0, 2.0, 0.004, 10)
}
